...
export default class App extends React.Component {
    ...
    validation() {
        ...
        if (!this.state.degree) {
            degreeErrorMessage.push("انتخاب کردن این فیلد ضروری است");
            hasError = true;
        }
                                        ...
                                        <Container component="div" maxWidth="lg">
                                            <Grid container spacing={4}>
                                                ...
                                                <Grid item sm={6}>
                                                    <TextField
                                                        name="degree"
                                                        error={!!this.state.degreeErrorMessage.length}
                                                        label="درجه را وارد کنید"
                                                        fullWidth={true}
                                                    ...
                                                    />
                                                    {this.state.degreeErrorMessage.map(message => (
                                                        <Typography key={Math.random()}
                                                                    className={`error-message f-smaller`}>{message}</Typography>
                                                    ))}
                                                </Grid>
